      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div className="navbar-nav">
            ...
            <NavLink to="" className="nav-link  h5  text-center" style={{paddingLeft:20}} onClick={ op_estadistica } >Estadisticas</NavLink>
            ...
            <a className="nav-link  h5  text-center" href=" " style={{paddingLeft:20}} onClick={ cerrarSesion } ><u>Cerrar Sesión</u></a>
          </div>
        </div>
      </div>
    </nav>
